...
namespace Vkxel {
    ...
    Scene SceneLibrary::TestScene() {
        ...
        gpu_dual_contouring.minBound = glm::vec3{-1.2};
        gpu_dual_contouring.maxBound = glm::vec3{1.2};
        ...
        dual_contouring.minBound = glm::vec3{-1.2};
        dual_contouring.maxBound = glm::vec3{1.2};
