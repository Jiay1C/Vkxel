...
{                                                                                                               \
    if (!(f))                                                                                                   \
    {                                                                                                           \
        std::cerr << "Error: nullptr or false in " << __FILE__ << " at line " << __LINE__ << ". Msg: " << msg << std::endl;   \
        abort();                                                                                                \
    }                                                                                                           \
}
...
{                                                                                                              \
    ...
    if (res != success)                                                                                        \
    {                                                                                                          \
        std::cerr << "Error: " << res << " in " << __FILE__ << " at line " << __LINE__ << ". Msg: " << msg << std::endl; \
        abort();                                                                                               \
    }                                                                                                          \
}
...
{                                                                                                              \
    ...
    if (res != VK_SUCCESS)                                                                                     \
    {                                                                                                          \
        std::cerr << "Error: " << string_VkResult(res) << " in " << __FILE__ << " at line " << __LINE__ << ". Msg: " << msg << std::endl; \
        abort();                                                                                               \
    }                                                                                                          \
}
